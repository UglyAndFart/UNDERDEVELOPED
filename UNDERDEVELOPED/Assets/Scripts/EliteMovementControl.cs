...
public class EliteMovementControl : MonoBehaviour
{
    [SerializeField]
    ...
    private bool _attacking = false, _hurt = false, _aggro = false, _activeHP = true;
    ...
    private void Start()
    {
        ...
        // BossHealth._instance.SetBoss(GetComponent<Enemy>());
    ...
    private void CheckMove()
    {
        ...
        if (!_aggro)
        {
            if (_distance > _aggroRange)
            {
                ...
                // HUDManager._instance.OpenBossHealthbar();                
                return;
            }
            _aggro = true;
        }
